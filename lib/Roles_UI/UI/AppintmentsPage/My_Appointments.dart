...
import '../../JUNIOR_DOCTOR/appoinment/appointmentPage.dart';
...
class _MyAppointmentsState extends State<MyAppointments> {
  ...
  void initState() {
    super.initState();
    Get.find<SlotListController>().SlotDataz(widget.token);
  }
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  autofocus: false,
                  onChanged: (value) {
                    Get.find<SlotListController>().SearchslotList(value);
                  },
                  ...
                  decoration: InputDecoration(
                      ...
                      hintText: "Search Patients Slots",
                      prefixIcon: Padding(
            ...
            Expanded(
              child: GetX<SlotListController>(
                builder: (SlotListController controller) {
                  ...
                  if (controller.SlotList.isEmpty) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final patientData = controller.SlotList[index];
                        return GestureDetector(
                          ...
                          child: ListTile(
                            ...
                            title: Text(
                              "${patientData?.patientDetails?.name?.toUpperCase() ?? "No Name"}",
                              style: TextStyle(
                                color: Colors.blueGrey,
                                fontSize: 15.h,
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                Text(
                                  ...
                                  "DATE: ${patientData?.slotDetails?.date?.toUpperCase() ?? "No Name"}",
                                  style: TextStyle(
                                    fontSize: 12.h,
                                    color: Colors.blueGrey,
                                    fontWeight: FontWeight.bold,
                                ...
                                Text(
                                  "[ FROM TIME: ${patientData?.slotDetails?.fromTime?.toUpperCase() ?? "No Name"}   TO TIME: ${patientData?.slotDetails?.toTime?.toUpperCase() ?? "No Name"} ]",
                                  style: TextStyle(
                                    fontSize: 12.h,
                                    color: Colors.blueGrey,
                                    fontWeight: FontWeight.bold,
                            ...
                            trailing: Row(
                              ...
                              children: [
                                patientData?.consulted == true ?  ClipOval(
                                  child: Image.asset(
