...
class DoctorAllListController extends GetxController {
  ...
  Future<void> doctorallListData(String token) async {
    print("-----benebebn");

    isLoading.value = true;
    isLoaded.value = false;
    try {
      Map<String, dynamic> resp = await ApiServices.doctorallList(token: token);
